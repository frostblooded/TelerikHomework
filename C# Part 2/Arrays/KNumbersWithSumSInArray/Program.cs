...
class IsThereSumS
{
    ...
    static void Main()
    {
        ...
        Console.WriteLine("The sum of how many numbers should equal the searched sum?");
        int searchedSumNumbersCount = int.Parse(Console.ReadLine());
        ...
        {
            if (item.Count == searchedSumNumbersCount)
            {
